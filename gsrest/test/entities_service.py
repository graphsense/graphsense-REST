...
eth_entityWithTagsOutNeighbors = NeighborEntities(next_page=None,
...
entityWithTagsAddresses = EntityAddresses(next_page=None,
                                          addresses=[addressD, addressE])

tag_entityA = Entity(currency='btc',
                     no_address_tags=2,
                     no_outgoing_txs=0,
...
tag_entityB = Entity(currency='btc',
                     no_address_tags=2,
                     no_outgoing_txs=0,
                     last_tx=TxSummary(timestamp=1434554207,
                                       height=1,
...
tag_entityC = Entity(currency='btc',
                     no_address_tags=3,
                     no_outgoing_txs=0,
                     last_tx=TxSummary(timestamp=1434554207,
                                       height=1,
...
tag_entityD = Entity(currency='btc',
                     no_address_tags=1,
                     no_outgoing_txs=0,
                     last_tx=TxSummary(timestamp=1434554207,
                                       height=1,
...
tag_entityE = Entity(currency='btc',
                     no_address_tags=3,
                     no_outgoing_txs=0,
                     last_tx=TxSummary(timestamp=1434554207,
                                       height=1,
...
async def list_address_tags_by_entity(test_case):
    ...
    result = await test_case.request(path,
                                     ...
                                     level='address')
    public_address_tags = [
        tag.to_dict() for tag in expected if tag.tagpack_is_public
    ]
...
async def list_entity_addresses(test_case):
    ...
    test_case.assertEqual(
        EntityAddresses(next_page=None, addresses=[eth_address]).to_dict(),
        result)
...
async def search_entity_neighbors(test_case):
    ...
    test_case.assertEqual(
        123, result[0]['paths'][0]['neighbor']['entity']['entity'])
    test_case.assertEqual(category, result[0]['paths'][0]['neighbor']['entity']
                          ['best_address_tag']['category'])  # noqa
    ...
    test_case.assertEqual(2818641, result[0]['neighbor']['entity']['entity'])
    test_case.assertEqual(
        456, result[0]['paths'][0]['neighbor']['entity']['entity'])
    test_case.assertEqual(
        addresses,
    ...
    test_case.assertEqual(2818641, result[0]['neighbor']['entity']['entity'])
    test_case.assertEqual(
        789, result[0]['paths'][0]['neighbor']['entity']['entity'])
    test_case.assertEqual(
        10,
        result[0]['paths'][0]['neighbor']['entity']['total_received']['value'])
    ...
    test_case.assertEqual(
        789, result[0]['paths'][0]['neighbor']['entity']['entity'])
    test_case.assertEqual(
        100.0, result[0]['paths'][0]['neighbor']['entity']['total_received']
        ['fiat_values'][0]['value'])
