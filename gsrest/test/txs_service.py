...
tx1 = TxUtxo(height=1,
             ...
             coinbase=False,
             outputs=[
                 TxValue(address=["1HxbaBMF2jXBVnagoHvaA6rLxmaYL8gb8T"],
                         value=make_values(eur=0.0, usd=0.0, value=75000000)),
                 TxValue(address=["1MaFeRMwbk7AMk4fRd3xXpSiehoSqsvE5X"],
...
tx2 = TxUtxo(timestamp=1373266967,
             currency='btc',
             ...
             outputs=[
                 TxValue(address=["138cWsiAGpW9yqfjMVCCsFcnaiSHyoWMnJ"],
                         value=make_values(eur=0.0, usd=0.0, value=1)),
                 TxValue(address=["1CRqaDkksF1zp6wLunY7ygSafXsiftH9FN"],
                         value=make_values(eur=0.1, usd=0.2, value=9949999))
             ],
             inputs=[
                 TxValue(address=["1H8omroLCN2578Mj6sDrWa8YueqWEckNKY"],
...
tx3 = TxUtxo(timestamp=1373266967,
             currency='btc',
             total_output=make_values(eur=0.1, usd=0.2, value=9950000),
             coinbase=False,
             tx_hash="00ab188013",
...
tx22_eth = TxAccount(tx_hash='af6e0004',
                     currency='eth',
                     height=3,
                     timestamp=16,
                     from_address='0xabcdef',
                     to_address='0x123456',
                     value=make_values(eur=124.0,
                                       usd=248.0,
                                       value=124000000000000000000))

tx3_eth = TxAccount(tx_hash='ab188013',
                    currency='eth',
                    height=1,
                    timestamp=17,
                    from_address='0xabcdef',
                    to_address='0x123456',
                    value=make_values(eur=234.0,
                                      usd=468.0,
                                      value=234000000000000000000))

tx4_eth = TxAccount(tx_hash='123456',
                    currency='eth',
                    height=4,
                    timestamp=17,
                    from_address='0xabcdef',
