...
async def get_actor(test_case):
    ...
    test_case.assertEqual(
        {
            "categories": [
                ...
                {"id": "exchange", "label": "An exchange"},
            ],
            "id": "actorX",
            "jurisdictions": [
                {"id": "SC", "label": "Singapore"},
                {"id": "VU", "label": "Vanuatu"},
            ],
            "label": "Actor X",
            "nr_tags": 2,
    ...
    test_case.assertEqual(
        {
            "categories": [{"id": "conceptB", "label": "Concept B"}],
            "id": "actorY",
...
async def list_address_tags(test_case):
    ...
    test_case.assertEqual([tag6.to_dict(), tag7.to_dict()], result["address_tags"])
