...
class BlocksApi:
    ...
    def get_block(
        ...
        height: Annotated[StrictInt, Field(description="The block height")],
    ...
    def _get_block_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{currency}/blocks/{height}',
    ...
    def get_block_by_date(
        ...
        :param currency: The cryptocurrency code (e.g., btc) (required)
        :type currency: str
        :param var_date: The date (YYYY-MM-DD) (required)
        :type var_date: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_block_by_date_serialize(
            currency=currency,
            var_date=var_date,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _get_block_by_date_serialize(
        self,
        currency,
        var_date,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{currency}/block_by_date/{date}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_block_txs(
        ...
        _param = self._list_block_txs_serialize(
            currency=currency,
            height=height,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call_compat
    def list_block_txs_with_http_info(
        self,
        currency: Annotated[StrictStr, Field(description="The cryptocurrency code (e.g., btc)")],
        height: Annotated[StrictInt, Field(description="The block height")],
        _request_timeout: Union[
    ...
    @validate_call_compat
    def list_block_txs_without_preload_content(
        self,
        currency: Annotated[StrictStr, Field(description="The cryptocurrency code (e.g., btc)")],
        height: Annotated[StrictInt, Field(description="The block height")],
        _request_timeout: Union[
    ...
    def _list_block_txs_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{currency}/blocks/{height}/txs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
