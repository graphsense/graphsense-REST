...
class Concept(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, label, taxonomy, uri, description, id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, label, taxonomy, uri, description, id, *args, **kwargs):  # noqa: E501
        """Concept - a model defined in OpenAPI
