...
class UserReportedTag(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, address, network, label, actor, description, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, address, network, label, actor, description, *args, **kwargs):  # noqa: E501
        """UserReportedTag - a model defined in OpenAPI
