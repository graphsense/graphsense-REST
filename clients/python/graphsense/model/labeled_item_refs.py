...
class LabeledItemRefs(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """LabeledItemRefs - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([LabeledItemRef]): The list of matching actors.  # noqa: E501

        Keyword Args:
            value ([LabeledItemRef]): The list of matching actors.  # noqa: E501
