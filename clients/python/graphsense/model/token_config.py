...
class TokenConfig(ModelNormal):
    ...
    attribute_map = {
        ...
        'peg_currency': 'peg_currency',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ticker, decimals, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            peg_currency (str): is set if token is a stablecoin. It holds the thicker symbol of the currency the tokens is pegged to.. [optional]  # noqa: E501
            contract_address (str): the contract address of the token on the blockchain. This is only set for tokens that are not native to the blockchain.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, ticker, decimals, *args, **kwargs):  # noqa: E501
        """TokenConfig - a model defined in OpenAPI
