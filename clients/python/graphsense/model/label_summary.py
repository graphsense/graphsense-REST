...
class LabelSummary(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'relevance': (float,),  # noqa: E501
            'creators': ([str],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, label, count, confidence, relevance, creators, sources, concepts, lastmod, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, label, count, confidence, relevance, creators, sources, concepts, lastmod, *args, **kwargs):  # noqa: E501
        """LabelSummary - a model defined in OpenAPI
