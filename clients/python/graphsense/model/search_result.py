...
class SearchResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, currencies, labels, *args, **kwargs):  # noqa: E501
        """SearchResult - a model defined in OpenAPI

        Args:
            currencies ([SearchResultByCurrency]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, currencies, labels, *args, **kwargs):  # noqa: E501
        """SearchResult - a model defined in OpenAPI
