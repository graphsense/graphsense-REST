...
class TokenConfigs(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'token_configs': ([TokenConfig],),  # noqa: E501
        }
    ...
    attribute_map = {
        'token_configs': 'token_configs',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, token_configs, *args, **kwargs):  # noqa: E501
        """TokenConfigs - a model defined in OpenAPI

        Args:
            token_configs ([TokenConfig]): list of supported tokens and their parameters
    ...
    @convert_js_args_to_python_args
    def __init__(self, token_configs, *args, **kwargs):  # noqa: E501
        """TokenConfigs - a model defined in OpenAPI
