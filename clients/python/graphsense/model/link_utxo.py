...
class LinkUtxo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tx_hash, currency, height, timestamp, input_value, output_value, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, tx_hash, currency, height, timestamp, input_value, output_value, *args, **kwargs):  # noqa: E501
        """LinkUtxo - a model defined in OpenAPI
