...
class SearchResultLevel1(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'neighbor': (NeighborEntity,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, neighbor, matching_addresses, paths, *args, **kwargs):  # noqa: E501
        """SearchResultLevel1 - a model defined in OpenAPI

        Args:
            neighbor (NeighborEntity):
            matching_addresses ([Address]):
            paths ([SearchResultLevel2]): Branches to matching entities
    ...
    @convert_js_args_to_python_args
    def __init__(self, neighbor, matching_addresses, paths, *args, **kwargs):  # noqa: E501
        """SearchResultLevel1 - a model defined in OpenAPI
