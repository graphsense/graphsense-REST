...
class Txs(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, txs, *args, **kwargs):  # noqa: E501
        """Txs - a model defined in OpenAPI

        Args:
            txs ([Tx]): A list of transaction model transactions
    ...
    @convert_js_args_to_python_args
    def __init__(self, txs, *args, **kwargs):  # noqa: E501
        """Txs - a model defined in OpenAPI
