...
class TagCloudEntry(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cnt, weighted, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, cnt, weighted, *args, **kwargs):  # noqa: E501
        """TagCloudEntry - a model defined in OpenAPI
