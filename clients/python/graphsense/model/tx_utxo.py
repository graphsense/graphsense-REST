...
class TxUtxo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, currency, tx_hash, coinbase, height, no_inputs, no_outputs, timestamp, total_input, total_output, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, currency, tx_hash, coinbase, height, no_inputs, no_outputs, timestamp, total_input, total_output, *args, **kwargs):  # noqa: E501
        """TxUtxo - a model defined in OpenAPI
