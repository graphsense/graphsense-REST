...
from graphsense.api_response import ApiResponse, T as ApiResponseT
import graphsense.models
...
class ApiClient:
    ...
    def response_deserialize(
        ...
        return ApiResponse(
            ...
            data = CompatList(return_data) if isinstance(return_data, list) else return_data,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(graphsense.models, klass)
