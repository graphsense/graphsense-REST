...
class Links(BaseModel):
    ...
    """ # noqa: E501
    links: List[LinksInner]
    next_page: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["links", "next_page"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "links": [LinksInner.from_dict(_item) for _item in obj["links"]] if obj.get("links") is not None else None,
