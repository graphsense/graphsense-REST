...
class TxAccount(BaseModel):
    ...
    """ # noqa: E501
    tx_type: Optional[StrictStr] = 'account'
    ...
    token_tx_id: Optional[StrictInt] = None
    fee: Optional[Values] = None
    contract_creation: Optional[StrictBool] = None
    is_external: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["tx_type", "identifier", "currency", "network", "tx_hash", "height", "timestamp", "value", "from_address", "to_address", "token_tx_id", "fee", "contract_creation", "is_external"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tx_type": obj.get("tx_type") if obj.get("tx_type") is not None else 'account',
            ...
            "token_tx_id": obj.get("token_tx_id"),
            "fee": Values.from_dict(obj["fee"]) if obj.get("fee") is not None else None,
            "contract_creation": obj.get("contract_creation"),
