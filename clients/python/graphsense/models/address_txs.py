...
class AddressTxs(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["address_txs", "next_page"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in address_txs (list)
        _items = []
        if self.address_txs:
            for _item_address_txs in self.address_txs:
                if _item_address_txs:
                    _items.append(_item_address_txs.to_dict())
            _dict['address_txs'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "address_txs": [AddressTx.from_dict(_item) for _item in obj["address_txs"]] if obj.get("address_txs") is not None else None,
