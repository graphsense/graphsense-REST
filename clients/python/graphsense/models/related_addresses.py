...
class RelatedAddresses(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in related_addresses (list)
        _items = []
        if self.related_addresses:
            for _item_related_addresses in self.related_addresses:
                if _item_related_addresses:
                    _items.append(_item_related_addresses.to_dict())
            _dict['related_addresses'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "related_addresses": [RelatedAddress.from_dict(_item) for _item in obj["related_addresses"]] if obj.get("related_addresses") is not None else None,
