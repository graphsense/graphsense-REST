...
This server was generated by the [OpenAPI Generator][openapi-generator] project. 
...
Test instance configuration template can be found in `tests/config.yaml.tmp`.
