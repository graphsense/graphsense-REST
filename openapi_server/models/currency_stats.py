...
class CurrencyStats(Model):
    ...
    def __init__(self, name=None, no_blocks=None, no_address_relations=None, no_addresses=None, no_entities=None, no_txs=None, no_labels=None, timestamp=None, tools=None, notes=None, data_sources=None):  # noqa: E501
