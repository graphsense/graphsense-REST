...
class TxUtxo(Model):
    ...
    def __init__(self, tx_type='utxo', tx_hash=None, coinbase=None, height=None, inputs=None, outputs=None, timestamp=None, total_input=None, total_output=None):  # noqa: E501
