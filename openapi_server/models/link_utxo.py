...
class LinkUtxo(Model):
    ...
    def __init__(self, currency_type='utxo', tx_hash=None, height=None, timestamp=None, input_value=None, output_value=None):  # noqa: E501
        """LinkUtxo - a model defined in OpenAPI

        :param currency_type: The currency_type of this LinkUtxo.  # noqa: E501
    ...
    def currency_type(self):
        """Gets the currency_type of this LinkUtxo.


        :return: The currency_type of this LinkUtxo.
        :rtype: str
        """
    ...
    def currency_type(self, currency_type):
        """Sets the currency_type of this LinkUtxo.


        :param currency_type: The currency_type of this LinkUtxo.
        :type currency_type: str
        """
        if currency_type is None:
            raise ValueError("Invalid value for `currency_type`, must not be `None`")  # noqa: E501
