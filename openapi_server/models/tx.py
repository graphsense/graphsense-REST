...
class Tx(Model):
    ...
    @property
    def fee(self):
        """Gets the fee of this Tx.


        :return: The fee of this Tx.
        :rtype: Values
        """
        return self._fee
