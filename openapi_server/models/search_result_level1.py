...
class SearchResultLevel1(Model):
    ...
    def __init__(self, neighbor: NeighborEntity=None, matching_addresses: List[Address]=None, paths: List[SearchResultLevel2]=None):
        """SearchResultLevel1 - a model defined in OpenAPI

        :param neighbor: The neighbor of this SearchResultLevel1.
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SearchResultLevel1':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The search_result_level1 of this SearchResultLevel1.
        """
    ...
    @property
    def neighbor(self):
        """Gets the neighbor of this SearchResultLevel1.


        :return: The neighbor of this SearchResultLevel1.
    ...
    def neighbor(self, neighbor):
        """Sets the neighbor of this SearchResultLevel1.
