...
INSERT INTO tag (label, address, currency, category, source, tagpack, lastmod, is_cluster_definer, confidence) VALUES
    ...
    ('x', 'tag_addressC', 'BTC', NULL, 'Unspecified', 'https://tagpack_uri', to_timestamp(2), true, 'ownership'),
    ('y', 'tag_addressD', 'BTC', NULL, 'Unspecified', 'https://tagpack_uri', to_timestamp(2), false, 'ownership'),
    ('x', 'tag_addressE', 'BTC', NULL, 'Unspecified', 'https://tagpack_uri', to_timestamp(2), true, 'ownership'),
    ('y', 'tag_addressF', 'BTC', NULL, 'Unspecified', 'https://tagpack_uri', to_timestamp(2), true, 'forensic'),
    ('z', 'tag_addressG', 'BTC', NULL, 'Unspecified', 'https://tagpack_uri', to_timestamp(2), true, 'web_crawl'),
    ('x', 'tag_addressH', 'BTC', NULL, 'Unspecified', 'https://tagpack_uri', to_timestamp(2), false, 'ownership'),
    ('x', 'tag_addressI', 'BTC', NULL, 'Unspecified', 'https://tagpack_uri', to_timestamp(2), false, 'ownership'),
    ('y', 'tag_addressI', 'BTC', NULL, 'Unspecified', 'https://tagpack_uri', to_timestamp(2), false, 'ownership'),
    ('z', 'tag_addressI', 'BTC', NULL, 'Unspecified', 'https://tagpack_uri', to_timestamp(2), false, 'ownership'),
